...
label_mainImage = Label(root, text = "Main Image", bg="#006775", fg="#ffffff")
label_cluster0 = Label(root, text = "Cluster 0", bg="#006775", fg="#ffffff")
label_cluster1 = Label(root, text = "Cluster 1", bg="#006775", fg="#ffffff")
label_cluster2 = Label(root, text = "Cluster 2", bg="#006775", fg="#ffffff")
...
entry_infectedClusterNo = Entry(clusterInputFrame, bd=4)
...
label_binary0 = Label(root, text = "Binary of original main image", bg="#006775", fg="#ffffff")
label_binary1 = Label(root, text = "Binary of infected region", bg="#006775", fg="#ffffff")
